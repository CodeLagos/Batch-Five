print("Name-EKONG EMMANUEL")
print("Phone number-08127755594")
print("Email-ekongemmanuel669@gmail.com")
print("BATCH 5")
#the purpose of this program
print("THIS PROGRAM ACTS AS A GAME")
print("\n")
try:
    while True:
        from tkinter import *
        ...
        def checker(buttons):
            ...
            if buttons["text"]==" " and click==True:
                ...
                tkinter.messagebox.showinfo("Winner X","You win player X!!")
                ...
                tkinter.messagebox.showinfo("Winner O","You win player O!!")
