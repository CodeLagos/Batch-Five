...
System.out.printf( "%s\n%s\n %s\n %s\n",
 ...
 } // end method inputGrades // add 1 to appropriate counter for specified grade
 void incrementLetterGradeCounter( int grade )
         switch ( grade / 10 )
{
...
// display a report based on the grades entered by the user
 ...
 "B: ", bCount, // display number of B grades "C: ", cCount, // display number of C grades
